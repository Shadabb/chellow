[
        ...
        'status_code': 303},
    {
        ...
        'status_code': 303,
        'regexes': [
            r"/reports/115/output/\?hhdc_contract_id=58"]},
...
""",
    ...
    # Check that we can see HHDC rate script okay. Contract 58.
    {
        'path': '/chellow/reports/173/output/?hhdc_rate_script_id=233',
    ...
    # Contract 58.
    {
        'path': '/chellow/reports/249/output/?hhdc_rate_script_id=233',
    ...
    # Add another HHDC contract
    {
        ...
        'status_code': 303,
        'regexes': [
            r"/reports/115/output/\?hhdc_contract_id=59"]},
...
""",
    ...
    # View Dynamat HHDC
    {
        'path': '/chellow/reports/279/output/?hhdc_contract_id=59',
        'status_code': 200,
        'regexes': [
...
""",
    ...
    # Check that it's displayed properly
    {
        ...
        'status_code': 200},
    {
        'path': '/chellow/reports/77/output/?supplier_contract_id=60',
        'regexes': [
    ...
    {
        'name': "Update the associated rate script. Supplier contract 60",
        'path': '/chellow/reports/319/output/',
        'method': 'post',
        'data': {
            'supplier_rate_script_id': "235",
            'start_year': "2000",
            'start_month': "01",
            'start_day': "03",
            'start_hour': "00",
...
"""},
    ...
    # Create a new non-core contract
    {
        ...
        'data': {
            ...
            'start_minute': "00"},
        'regexes': [
            r"/chellow/reports/267/output/\?non_core_contract_id=61"],
        'status_code': 303},
...
""",
        ...
        'status_code': 303},
    {
        'path': '/chellow/reports/267/output/?non_core_contract_id=61',
        'regexes': [
            r"import sys\s*def"],
        'status_code': 200},
        ...
        'status_code': 303},
    {
        ...
        'status_code': 303,
        'regexes': [
            r"/reports/107/output/\?mop_contract_id=62"]},
...
""",
    ...
    {
        'path': '/chellow/reports/107/output/?mop_contract_id=62',
        'status_code': 200},
...
""",
            'properties': "{}", },
        'regexes': [
            r"/chellow/reports/77/output/\?supplier_contract_id=63"],
        'status_code': 303},
    {
        'name': "Update the associated rate script. Supplier contract 63",
        'path': '/chellow/reports/319/output/',
        'method': 'post',
        'data': {
            'supplier_rate_script_id': "238",
            'start_year': "2000",
            'start_month': "01",
            'start_day': "03",
            'start_hour': "00",
...
""",
    ...
    {
        'name': "General import of supplies. Give proper error if there are "
        "too few fields.",
        'path': '/chellow/reports/293/output/',
        'method': 'post',
...

    {
        ...
        'regexes': [
            r"start_year",
            r'<option value="58" selected>HH contract</option>',
            r'"imp_supplier_contract_id">\s*'
            '<option value="60" selected>Half-hourlies 2007',
    ...
    # with #F2
    {
        ...
        'regexes': [
            r"/reports/65/output/\?hhdc_contract_id=58&process_id=0"],
        'status_code': 303},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&process_id=0',
        'method': 'post',
        'tries': {},
        'regexes': [
    ...
    # Import some hh Stark DF2 data
    {
        ...
        'status_code': 303,
        'regexes': [
            r"/reports/65/output/\?hhdc_contract_id=58&process_id=1", ], },
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&process_id=1',
        'tries': {},
        ...
        'regexes': [
            ...
            r"/chellow/reports/115/output/\?hhdc_contract_id=58"],
        'status_code': 200},
    ...
    # with a gap before it.
    {
        ...
        'regexes': [
            r"/reports/65/output/\?hhdc_contract_id=58&process_id=3"],
        'status_code': 303},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&process_id=3',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully."],
        'status_code': 200},
    ...
    # This relies on the default timezone being BST },
    {
        ...
        'regexes': [
            r"/chellow/reports/65/output/\?hhdc_contract_id=58&process_id=4"],
        'status_code': 303},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&process_id=4',
    ...
    # Test that 3 non-actual reads in a row generate a single snag
    {
        ...
        'regexes': [
            r"/chellow/reports/65/output/\?hhdc_contract_id=58&process_id=5"],
        'status_code': 303},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&process_id=5',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully."],
        'status_code': 200},
        ...
        'status_code': 200},
    {
        ...
        'regexes': [
            r'/reports/65/output/\?hhdc_contract_id=58&process_id=6'],
        'status_code': 303},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&process_id=6',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully."],
        'status_code': 200},
    ...
    # Test if a CSV HH file can be imported },
    {
        ...
        'regexes': [
            r"/reports/65/output/\?hhdc_contract_id=58&process_id=7"],
        'status_code': 303},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&process_id=7',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully."],
        'status_code': 200},
    ...
    # missing
    {
        ...
        'regexes': [
            r"/reports/65/output/\?hhdc_contract_id=58&process_id=8"],
        'status_code': 303},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&process_id=8',
        'tries': {},
        'regexes': [
    ...
    # Check it gives a sensible error message if the first mpan is malformed
    {
        ...
        'regexes': [
            r"/reports/65/output/\?hhdc_contract_id=58&process_id=9"],
        'status_code': 303},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&process_id=9',
        'tries': {},
        'regexes': [
...

    {
        ...
        'regexes': [
            r"/reports/65/output/\?hhdc_contract_id=58&process_id=10"],
        'status_code': 303},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&'
        'process_id=10',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully\."],
        ...
        'status_code': 303},
    {
        ...
        'files': {'import_file': 'test/ftp/hh_data.df2'},
        'regexes': [
            r"/reports/65/output/\?hhdc_contract_id=58&process_id=11"],
        'status_code': 303},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&'
        'process_id=11',
    ...
    # Create a new import. Supplier contract 63
    {
        'name': "Bill imports",
        ...
        'status_code': 303},
    {
        ...
        'status_code': 303,
        'regexes': [
            r"/chellow/reports/65/output/\?hhdc_contract_id=58&process_id=12"]
        },
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58'
        '&process_id=12',
            ...
            r"/chellow/reports/257/output/\?user_id=5"]},
    {
        ...
        'hhdc-contract-id=58&hidden_days=5',
        ...
        'regexes': [
            ...
            r"ignored\.",
            r'<a href="/chellow/reports/115/output/\?hhdc_contract_id=58">HH '
            'contract</a>',
            r'<li>\s*'
...
""",
        ...
        'status_code': 303},
    {
        'path': '/chellow/reports/115/output/?hhdc_contract_id=58',
        'status_code': 200,
        'regexes': [
            ...
            r'Rate Scripts\s*'
            '\[<a href="/chellow/reports/383/output/\?hhdc_contract_id=58">'
            'add</a>\]']},
        ...
        'status_code': 200},
    {
        ...
        'path': '/chellow/reports/325/output/?supplier_contract_id=64',
        'regexes': [
            r"/chellow/reports/77/output/\?supplier_contract_id=64"]},
    {
        'name': "Check 'HH Contract' option is there. Supply 9.",
        'path': '/chellow/reports/307/output/?era_id=9',
        'regexes': [
            r'<option value="58">HH contract</option>\s*</select>']},
    {
...
""",
...

    {
        ...
        'path': '/chellow/reports/317/output/?supplier_contract_id=65',
        'status_code': 404},
    ...
    # Create an HHDC contract
    {
        ...
        'status_code': 303,
        'regexes': [
            r"/chellow/reports/115/output/\?hhdc_contract_id=66"]},
    ...
    {
        'path': '/chellow/reports/115/output/?hhdc_contract_id=66',
        'status_code': 404},
...

    {
        ...
        'data': {
            ...
            'start_minute': "00"},
        'regexes': [
            r"/reports/267/output/\?non_core_contract_id=67"],
        'status_code': 303},
...
"""},
        ...
        'status_code': 200},
    {
        ...
        'path': '/chellow/reports/81/output/?hhdc_contract_id=58&months=1&'
    ...
    # Insert rate script
    {
        ...
        'data': {
            ...
            'start_minute': "00"},
        'regexes': [
            r"/chellow/reports/69/output/\?dno_rate_script_id=244"],
        'status_code': 303},
...
"""},
    ...
    # Try out simple.csv hh import format.
    {
        ...
        'status_code': 303,
        'regexes': [
            r"/reports/65/output/\?hhdc_contract_id=59&process_id=0"]},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=59&process_id=0',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully."],
        'status_code': 200},
...
""",
    ...
    {
        'name': "Change to new supplier contract. Supply 10",
        'path': '/chellow/reports/307/output/',
        'method': 'post',
        'data': {
            'era_id': "17",
    ...
    {
        'name': "Supplier contract 68, batch 7",
    ...
    # Supplier contract 68, batch 7, bill 10
    {
    ...
    {
        'name': "Check that it's there to edit. HHDC contract 58",
        'path': '/chellow/reports/283/output/?hhdc_batch_id=8',
        'status_code': 200},

    {
        'name': "Try adding bills to the HHDC batch. Contract 58",
    ...
    {
        'name': "Check that it's there in edit mode. Contract 62",
    ...
    {
        'name': "Check confirm-delete page. Contract 62",
        'path': '/chellow/reports/355/output/?mop_batch_id=9&'
    ...
    # Check we can see it in 'view' mode. Contract 63
    {
        ...
        'status_code': 200},
    {
        ...
        'data': {
            ...
            'insert': "Insert"},
        'regexes': [
            r"/chellow/reports/271/output/\?rate_script_id=246"],
        'status_code': 303},
    {
        'path': '/chellow/reports/273/output/?rate_script_id=246&'
        'delete=Delete',
        'regexes': [
        ...
        'status_code': 200},
    {
        ...
        'status_code': 303},
    {
        'path': '/chellow/reports/271/output/?rate_script_id=246',
        'status_code': 404},
    {
        ...
        'data': {
            ...
            'insert': "Insert"},
        'regexes': [
            r"/chellow/reports/271/output/\?rate_script_id=247"],
        'status_code': 303},
    {
        'path': '/chellow/reports/273/output/?rate_script_id=247',
        'regexes': [
    ...
    {
        'name': "Adding a bill manually. Supplier contract 60",
    ...
    {
        'name': "Supplier contract 58, batch 6",
        ...
        'status_code': 303},
    {
        ...
        'path': '/chellow/reports/287/output/?supplier_contract_id=68',
        'regexes': [
            r'="description"']},
    {
        'name': "Viewing the insert batch page of a DC contract.",
        'path': '/chellow/reports/281/output/?hhdc_contract_id=59',
        'regexes': [
            r'="description"']},
    {
...
""", },
    ...
    # Check that we can see a MOP batch okay. Contract 62
    {
        'path': '/chellow/reports/193/output/?mop_batch_id=9',
        'regexes': [
            r"/reports/2/output/"],
        ...
        'status_code': 200},
    {
        ...
        'status_code': 303,
        'regexes': [
            r"/reports/65/output/\?hhdc_contract_id=58&process_id=13"]},
    {
        'path': '/chellow/reports/65/output/?hhdc_contract_id=58&'
        'process_id=13',
        'tries': {},
        ...
        'status_code': 200},
    {
        ...
        'path': '/chellow/reports/211/output/?hhdc_contract_id=58',
        'status_code': 200,
        'regexes': [
            r"/reports/115/output/\?hhdc_contract_id=58"]},
...
"""},
    ...
    # Do an 'import now'
    {
        ...
        'data': {
            'hhdc_contract_id': "58"},
        'regexes': [
            '/reports/213/output/\?hhdc_contract_id=58'],
        'status_code': 303},
    # Check that file fr om FTP server has imported properly
    {
        'path': '/chellow/reports/213/output/?hhdc_contract_id=58',
        'tries': {},
        'regexes': [
            r"Finished loading"]},
    {
...
"""},
            ...
            '"2300","duos-availability-billed-kva","2300"']},
    {
        ...
        'path': '/chellow/reports/233/output/?hhdc_contract_id=58&'
        'days_hidden=1',
        'status_code': 200,
        'regexes': [
            ...
            r"CH017,displaced,2008-07-01,"]},
    {
        ...
        'regexes': [
            r'<tbody>\s*<tr>\s*<td>\s*'
            '<a href="/chellow/reports/77/output/\?supplier_contract_id=60">'
    ...
    {
        'name': "View a MOP rate script. Contract 62.",
        'path': '/chellow/reports/205/output/?mop_rate_script_id=237',
        'status_code': 200},
    {
    ...
    {
        'name': 'Delete it. HHDC contract 58',
        ...
        'status_code': 200},
    {
        ...
        'path': '/chellow/reports/87/output/?supplier_contract_id=60&'
...

    {
        ...
        'path': '/chellow/reports/109/output/?supplier_contract_id=60&'
    ...
    # Move finish date of era
    {
        ...
        'status_code': 303},
    {
        'path': '/chellow/reports/37/output/?hhdc-contract-id=58&'
        'hidden_days=5',
        'status_code': 200,
        'regexes': [
    ...
    {
        'name': 'Supplier contract 63, batch 12',
        'path': '/chellow/reports/323/output/?importer_id=1',
        'tries': {},
        'status_code': 200,
        'regexes': [
...

    {
        ...
        'status_code': 303},
    {
        'path': '/chellow/reports/271/output/?rate_script_id=166',
        'regexes': [
            r"2006-03-31 00:00"],
        'status_code': 200},
    {
    ...
    # Add in second batch
    {
        ...
        'status_code': 303},
    {
        'path': '/chellow/reports/93/output/?hhdc_contract_id=58',
        'status_code': 200,
        'regexes': [
            r'<tr>\s*<td>\s*'
    ...
    # Add in second batch
    {
        ...
        'status_code': 303},
    {
        'path': '/chellow/reports/191/output/?mop_contract_id=62',
        'status_code': 200,
        'regexes': [
            r'<tr>\s*<td>\s*'
...

    {
        ...
        'regexes': [
            ...
            '</a>\s*</td>\s*<td>\s*'
            '<a href="/chellow/reports/67/output/\?dno_contract_id=44">\s*'
...
""", },
...

    {
        ...
        'path': '/chellow/reports/247/output/?site_id=1&scenario_id=69',
        'status_code': 303},
    {
        'path': '/chellow/reports/251/output/',
        'tries': {},
...
"""},
    ...
    {
        'path': '/chellow/reports/247/output/?site_id=3&scenario_id=70',
        'status_code': 303},
    {
        'path': '/chellow/reports/251/output/',
        'tries': {'max': 30, 'period': 1},
...
""", },
        'regexes': [
            r"/reports/77/output/\?supplier_contract_id=71"],
        'status_code': 303},

    # Run scenario for a site
    {
        'path': '/chellow/reports/247/output/?site_id=3&scenario_id=71',
        'status_code': 303},
    {
        'path': '/chellow/reports/251/output/',
        'tries': {'max': 30, 'period': 1},
    ...
    {
        'name': "Look at a DNO",
        'path': '/chellow/reports/67/output/?dno_contract_id=42',
        'status_code': 200},
    {
...
""", },
        'regexes': [
            r"/reports/77/output/\?supplier_contract_id=72"],
        'status_code': 303},

    {
        'name': "Leap day forecast. Run scenario for a site",
        'path': '/chellow/reports/247/output/?site_id=5&scenario_id=72',
        'status_code': 303},
    {
        'path': '/chellow/reports/251/output/',
        'tries': {'max': 30, 'period': 1},
...

    {
        ...
        'path': '/chellow/reports/231/output/?mop_contract_id=62&'
