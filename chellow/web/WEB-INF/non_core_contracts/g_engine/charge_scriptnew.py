...
class DataSource():
    def __init__(
        ...
        #sys.stderr.write(
        #    "history start " + str(self.history_start) + ",history finish " +
        #    str(self.history_finish))
    ...
    def __init__(
        ...
        for i, hist_era in enumerate(hist_eras):
            ...
            if hist_measurement_type == 'unmetered':
                ...
                sys.stderr.write("doing hh amr for " + self.mpan_core + "\n")
...
""", params={
                    ...
                    while hh_date <= chunk_finish:
                        ...
                        try:
                            ...
                            status = 'X'
                            msp_kwh, anti_msp_kwh, imp_kvarh, exp_kvarh = 0
                    ...
                    sys.stderr.write("doing new stele chunk start " + hh_format(chunk_start) + " chunk finish " + hh_format(chunk_finish) + "\n")
...
""", params={
                    ...
                    while hh_date <= chunk_finish:
                        ...
                        try:
                            ...
                            status = 'X'
                            msp_kwh, status, imp_kvarh, exp_kvarh = 0
